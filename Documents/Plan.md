...
<td rowspan=2 align="center">Срок действия карты - 5 лет. <br> поэтому диапазон валидных дат будет: <br> от: <br><b>текущий месяц, текущий год</b> <br> до: <br><b> декабрь, текущий год + 5 </b> </td>
</tr>
