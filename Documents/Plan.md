...
:ballot_box_with_check: Откройте в браузере страницу **http://localhost:8080/** <br>
:ballot_box_with_check: На странице приложения нажмите кнопку «**Купить**» <br>
...
1a.1. В открывшейся форме заполните поля следующими данными: <br>
 :eight_spoked_asterisk: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
 :eight_spoked_asterisk: в поле `Месяц` введите **08** <br>
 :eight_spoked_asterisk: в поле `Год` введите **24**<br>
 :eight_spoked_asterisk: в поле `Владелец` введите **Vasya**<br>
 :eight_spoked_asterisk: в поле `CVC/CVV` введите **999** <br>
...
:eight_pointed_black_star: в поле `Номер карты` введите **4444 4444 4444 4442** <br>
:eight_spoked_asterisk: в поле `Месяц` введите **08** <br>
:eight_spoked_asterisk: в поле `год` введите **24** <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Vasya** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **999** <br>
...
:eight_pointed_black_star: поле `Номер карты` оставьте пустым <br>
:eight_spoked_asterisk: в поле `Месяц` введите **01** <br>
:eight_spoked_asterisk: в поле `Год` введите **24** <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Vasiliy Petrov** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **987** <br>
...
:eight_spoked_asterisk: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:eight_pointed_black_star: поле `Месяц` оставьте пустым <br>
:eight_spoked_asterisk: в поле `Год` введите **24** <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Ivan-Vasiliy Petrov** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **111** <br>
...
:eight_spoked_asterisk: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:eight_spoked_asterisk: в поле `Месяц` введите **12** <br>
:eight_pointed_black_star: поле `Год` оставьте пустым <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Ivan** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **222** <br>
...
:eight_spoked_asterisk: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:eight_spoked_asterisk: в поле `Месяц` введите **11** <br>
:eight_spoked_asterisk: в поле `Год` введите **26** <br>
:eight_pointed_black_star: поле `Владелец` оставьте пустым <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **222** <br>
...
:eight_spoked_asterisk: в поле `Месяц` введите **11** <br>
:eight_spoked_asterisk: в поле `Год` введите **26** <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Tatyana** <br>
:eight_pointed_black_star: поле `CVC/CVV` оставьте пустым <br>
...
:eight_pointed_black_star: в поле `Номер карты` введите **4444 4444 4444** <br>
:eight_spoked_asterisk: в поле `Месяц` введите **11** <br>
:eight_spoked_asterisk: в поле `Год` введите **27** <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Yan** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **987** <br>
...
:eight_spoked_asterisk: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:eight_pointed_black_star: в поле `Месяц` введите **08** <br>
:eight_spoked_asterisk: в поле `Год` введите **23** <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Vovan** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **987** <br>
...
:eight_spoked_asterisk: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:eight_pointed_black_star: в поле `Месяц` введите **13** <br>
:eight_spoked_asterisk: в поле `Год` введите **26** <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Anatoliy** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **186** <br>
...
:eight_spoked_asterisk: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:eight_spoked_asterisk: в поле `Месяц` введите **01** <br>
:eight_pointed_black_star: в поле `Год` введите **30** <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Anatoliy** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **555** <br>
...
:eight_spoked_asterisk: в поле `Месяц` введите **12** <br>
:eight_spoked_asterisk: в поле `Год` введите **27** <br>
:eight_pointed_black_star: в поле `Владелец` введите **Vovan$100** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **333** <br>
...
:eight_spoked_asterisk: в поле `Месяц` введите **12** <br>
:eight_spoked_asterisk: в поле `Год` введите **27** <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Aleksey** <br>
:eight_pointed_black_star: в поле `CVC/CVV` введите **000** <br>
...
:ballot_box_with_check: Откройте в браузере страницу **http://localhost:8080/** <br>
:ballot_box_with_check: На странице приложения нажмите кнопку «**Купить в кредит**» <br>
...
1b.1. В открывшейся форме заполните поля следующими данными: <br>
 :eight_spoked_asterisk: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
 :eight_spoked_asterisk: в поле `Месяц` введите **08** <br>
 :eight_spoked_asterisk: в поле `Год` введите **25** <br>
 :eight_spoked_asterisk: в поле `Владелец` введите **Petya** <br>
 :eight_spoked_asterisk: в поле «CVC/CVV» введите **999** <br>
...
:eight_pointed_black_star: поле `Номер карты` оставьте пустым <br>
:eight_spoked_asterisk: в поле `Месяц` введите **02** <br>
:eight_spoked_asterisk: в поле `Год` введите **28** <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Vasiliy Ivanov** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **999** <br>
...
:eight_pointed_black_star: поле `Год` оставьте пустым <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Ivan** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **202** <br>
...
:eight_spoked_asterisk: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:eight_spoked_asterisk: в поле `Месяц` введите **10** <br>
:eight_spoked_asterisk: в поле `Год` введите **27** <br>
:eight_pointed_black_star: поле `Владелец` оставьте пустым <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **222** <br>
...
:eight_pointed_black_star: в поле `Номер карты` введите **4444 4444 4444 222** <br>
:eight_spoked_asterisk: в поле `Месяц` введите **12** <br>
:eight_spoked_asterisk: в поле `Год` введите **27** <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Vovan** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **987** <br>
...
:eight_spoked_asterisk: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:eight_spoked_asterisk: в поле `Месяц` введите **12** <br>
:eight_pointed_black_star: в поле `Год` введите **22** <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Vovan** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **987** <br>
...
:eight_spoked_asterisk: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:eight_pointed_black_star: в поле `Месяц` введите **00** <br>
:eight_spoked_asterisk: в поле `Год` введите **26** <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Anatoliy** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **186** <br>
...
:eight_spoked_asterisk: в поле `Месяц` введите **12** <br>
:eight_spoked_asterisk: в поле `Год` введите **27** <br>
:eight_pointed_black_star: в поле `Владелец` введите **Пётр+(%)=** <br>
:eight_spoked_asterisk: в поле `CVC/CVV` введите **468** <br>
...
:eight_spoked_asterisk: в поле `Год` введите **27** <br>
:eight_spoked_asterisk: в поле `Владелец` введите **Aleksey** <br>
:eight_pointed_black_star: в поле `CVC/CVV` введите **43** <br>
