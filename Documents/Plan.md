...
1a.1. В открывшейся форме заполните поля следующими данными: <br>
 :white_medium_square: в поле `Номер карты` введите **4444 4444 4444 4441**<br>
 :white_medium_square: в поле `Месяц` и `Год` введите дату, соответствующую валидному диапазону (*см. таблицу входных данных*)  <br>
 :white_medium_square: в поле `Владелец` введите случайное валидное имя и фамилию на латинице <br>
 :white_medium_square: в поле `CVC/CVV` введите случайное трехзначное число в валидном диапазоне (*см. таблицу входных данных*) <br>
...
:black_medium_square: в поле `Номер карты` введите **4444 4444 4444 4442**<br>
:white_medium_square: в поле `Месяц` и `Год` введите дату, соответствующую валидному диапазону (*см. таблицу входных данных*)  <br>
:white_medium_square: в поле `Владелец` введите случайное валидное имя и фамилию на латинице <br>
:white_medium_square: в поле `CVC/CVV` введите случайное трехзначное число в валидном диапазоне (*см. таблицу входных данных*) <br>
...
:white_medium_square: в поле `Номер карты` введите **4444 4444 4444 4441**<br>
:white_medium_square: в поле `Месяц` введите валидный номер месяца <br>
...
:black_medium_square: в поле `Номер карты` введите случайное число из 15 цифр <br>
:white_medium_square: в поле `Месяц` и `Год` введите дату, соответствующую валидному диапазону (*см. таблицу входных данных*)  <br>
:white_medium_square: в поле `Владелец` введите случайное валидное имя и фамилию на латинице <br>
:white_medium_square: в поле `CVC/CVV` введите случайное трехзначное число в валидном диапазоне (*см. таблицу входных данных*) <br>
...
:white_medium_square: в поле `Номер карты` введите **4444 4444 4444 4441**<br>
:black_medium_square: в поле `Месяц` введите прошлый (относительно текущего) месяц  <br>
...
:white_medium_square: в поле `Номер карты` введите **4444 4444 4444 4441**<br>
:black_medium_square: в поле `Месяц` введите случайное, двухзначное число, больше 12<br>
:white_medium_square: в поле `Год` введите число из валидного диапазона для этого поля (*см. таблицу входных данных*)  <br>
:white_medium_square: в поле `Владелец` введите случайное валидное имя и фамилию на латинице <br>
:white_medium_square: в поле `CVC/CVV` введите случайное трехзначное число в валидном диапазоне (*см. таблицу входных данных*) <br>
...
:white_medium_square: в поле `Номер карты` введите **4444 4444 4444 4441**<br>
:white_medium_square: в поле `Месяц` и `Год` введите дату, соответствующую валидному диапазону (*см. таблицу входных данных*)  <br>
:black_medium_square: в поле `Владелец` введите имя на латинице, с добавлением спецсимволов и цифр <br>
:white_medium_square: в поле `CVC/CVV` введите случайное трехзначное число в валидном диапазоне (*см. таблицу входных данных*) <br>
...
:white_medium_square: в поле `Номер карты` введите **4444 4444 4444 4441**<br>
:white_medium_square: в поле `Месяц` и `Год` введите дату, соответствующую валидному диапазону (*см. таблицу входных данных*)  <br>
:black_medium_square: в поле `Владелец` введите один валидный символ (букву латиницы)<br>
:white_medium_square: в поле `CVC/CVV` введите случайное трехзначное число в валидном диапазоне (*см. таблицу входных данных*) <br>
...
:white_medium_square: в поле `Номер карты` введите валидный номер карты со статусом "**Одобрена**" (**APPROVED**) <br>
:white_medium_square: в поле `Месяц` и `Год` введите дату, соответствующую валидному диапазону (*см. таблицу входных данных*)  <br>
:white_medium_square: в поле `Владелец` введите случайное валидное имя и фамилию на латинице <br>
:black_medium_square: в поле `CVC/CVV` введите **000** <br>
...
:white_medium_square: в поле `Номер карты` введите **4444 4444 4444 4441**<br>
:white_medium_square: в поле `Месяц` введите валидный номер месяца <br>
:black_medium_square: в поле `Год` введите прошлый (относительно текущего) год <br>
:white_medium_square: в поле `Владелец` введите случайное валидное имя и фамилию на латинице <br>
:white_medium_square: в поле `CVC/CVV` введите случайное трехзначное число в валидном диапазоне (*см. таблицу входных данных*) <br>
...
:white_medium_square: в поле `Номер карты` введите **4444 4444 4444 4441**<br>
:black_medium_square: в поле `Месяц` введите **00** <br>
:white_medium_square: в поле `Год` введите число из валидного диапазона для этого поля (*см. таблицу входных данных*)  <br>
:white_medium_square: в поле `Владелец` введите случайное валидное имя и фамилию на латинице <br>
:white_medium_square: в поле `CVC/CVV` введите случайное трехзначное число в валидном диапазоне (*см. таблицу входных данных*) <br>
...
:white_medium_square: в поле `Номер карты` введите **4444 4444 4444 4441**<br>
:white_medium_square: в поле `Месяц` и `Год` введите дату, соответствующую валидному диапазону (*см. таблицу входных данных*)  <br>
:black_medium_square: в поле `Владелец` введите имя и фамилию на кириллице с добавлением спецсимволов<br>
:white_medium_square: в поле `CVC/CVV` введите случайное трехзначное число в валидном диапазоне (*см. таблицу входных данных*) <br>
...
:white_medium_square: в поле `Месяц` и `Год` введите дату, соответствующую валидному диапазону (*см. таблицу входных данных*)  <br>
:white_medium_square: в поле `Владелец` введите случайное валидное имя и фамилию на латинице <br>
:black_medium_square: в поле `CVC/CVV` введите случайное двухзначное число <br>
