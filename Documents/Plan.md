...
<td>Код проверки подлинности карты <br> (трехзначное, положительное число,<br> больше "нуля")  </td> 
</tr>
...
### 13b.	Покупка через сервис «Купить в кредит», некорректный код CVC/CVV  <br>
