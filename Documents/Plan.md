...
<td rowspan=2 align="center">Срок действия карты - 5 лет. <br> Предполагая, что карту выпустили в январе 2023 года, <br>диапазон валидных дат будет: <br> от: <br><b>текущий месяц и год</b> <br> до: <br> декабрь 2028 год (<b>12.28</b>)  </td>
</tr>
...
**(!)** При возникновении рисков, указанных в разделе "**III. Перечень и описание возможных рисков при автоматизации**" количество часов может увеличиться до 58.
 ...
 :date: Проведение ручного тестирования    - 29 сентября - 02 октября <br>
 :date: Написание и проведение автотестов  - 03-10 октября <br>
 :date: Анализ результатов и подготовка отчетов тестирования - 11-14 октября <br>
