...
<th>Тип данных <br><br> :large_blue_circle: :orange_circle: :green_circle: </th>
...
<th>НЕвалидный диапазон <br><br> :orange_circle: :orange_circle: :orange_circle:</th>  
</tr>
</thead>
...
<td> 0000 0000 0000 0001 - 4444 4444 4444 4440, <br> 4444 4444 4444 4442 - 9999 9999 9999 9999), <br> а также не соответствующие валидной длине</td>
</tr>
...
<td rowspan=2 align="center"><b>текущий месяц, год</b> - <br> - декабрь (<b>12</b>) , 20<b>28</b> год </td>
<td rowspan=2 align="center">Ранее <b>текущего месяца, текущего года</b> - <br> - позже декабря (<b>12</b>) , 20<b>28</b> года,<br> а также не соответствующие валидной длине </td>
</tr>
...
<td>Буквы (кирилица), спецсимволы: <br> !"№;%:?*()~@#$%^&*<>?'/, <br> а также не соответствующие валидной длине </td> 
</tr>
...
<td>000, а также числа не соответствующие валидной длине </td> 
</tr>
...
:orange_circle: в поле `Номер карты` введите **4444 4444 4444 4442** <br>
:green_circle: в поле `Месяц` введите **08** <br>
:green_circle: в поле `год` введите **24** <br>
:green_circle: в поле `Владелец` введите **Vasya** <br>
:green_circle: в поле `CVC/CVV` введите **999** <br>
...
:orange_circle: поле `Номер карты` оставьте пустым <br>
...
:green_circle: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:orange_circle: поле `Месяц` оставьте пустым <br>
:green_circle: в поле `Год` введите **24** <br>
...
:orange_circle: поле `Год` оставьте пустым <br>
...
:orange_circle: поле `Владелец` оставьте пустым <br>
:green_circle: в поле `CVC/CVV` введите **222** <br>
...
:orange_circle: поле `CVC/CVV` оставьте пустым <br>
...
:orange_circle: в поле `Номер карты` введите **4444 4444 4444** <br>
:green_circle: в поле `Месяц` введите **11** <br>
...
:green_circle: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:orange_circle: в поле `Месяц` введите **08** <br>
:green_circle: в поле `Год` введите **23** <br>
...
:green_circle: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:orange_circle: в поле `Месяц` введите **13** <br>
:green_circle: в поле `Год` введите **26** <br>
...
:green_circle: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:green_circle: в поле `Месяц` введите **01** <br>
:orange_circle: в поле `Год` введите **30** <br>
:green_circle: в поле `Владелец` введите **Anatoliy** <br>
...
:green_circle: в поле `Месяц` введите **12** <br>
:green_circle: в поле `Год` введите **27** <br>
:orange_circle: в поле `Владелец` введите **Vovan$100** <br>
...
:orange_circle: в поле `CVC/CVV` введите **000** <br>
...
:orange_circle: в поле `Номер карты` введите **4444 4444 4444 222** <br>
:green_circle: в поле `Месяц` введите **12** <br>
:green_circle: в поле `Год` введите **27** <br>
:green_circle: в поле `Владелец` введите **Vovan** <br>
:green_circle: в поле `CVC/CVV` введите **987** <br>
...
:green_circle: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:green_circle: в поле `Месяц` введите **12** <br>
:orange_circle: в поле `Год` введите **22** <br>
:green_circle: в поле `Владелец` введите **Vovan** <br>
:green_circle: в поле `CVC/CVV` введите **987** <br>
...
:green_circle: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:orange_circle: в поле `Месяц` введите **00** <br>
:green_circle: в поле `Год` введите **26** <br>
:green_circle: в поле `Владелец` введите **Anatoliy** <br>
:green_circle: в поле `CVC/CVV` введите **186** <br>
...
:green_circle: в поле `Номер карты` введите **4444 4444 4444 4441** <br>
:green_circle: в поле `Месяц` введите **01** <br>
:orange_circle: в поле `Год` введите **29** <br>
...
:green_circle: в поле `Месяц` введите **12** <br>
:green_circle: в поле `Год` введите **27** <br>
:orange_circle: в поле `Владелец` введите **Пётр+(%)=** <br>
...
:green_circle: в поле `Год` введите **27** <br>
:green_circle: в поле `Владелец` введите **Aleksey** <br>
:orange_circle:в поле `CVC/CVV` введите **43** <br>
